...
keywords = ["What is the number of publications","works", "articles","How many publications","How many papers","What is the number of papers","What is the number of scientific papers","scientific publications"]
...
filtered_output_file = 'questions_with_works.json'
